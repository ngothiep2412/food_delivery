...
func NewUnauthorizedError(root error, msg string, key string) *AppError {
	return &AppError{
...
func ErrInternal(err error) *AppError {
	return NewErrorResponse(err, "something went wrong in the server", err.Error(), "ErrorInternal")
}
